...
class Maratang3Spider(scrapy.Spider):
    name = 'maratang3'
    ...
    def parse_details(self, response):  
        ...
        item['title'] = str(response.xpath("//div[@class='se-module se-module-text se-title-text']/p/span/text()").get())
        item['content'] = str(response.xpath("//div[@class='se-main-container']").get())
